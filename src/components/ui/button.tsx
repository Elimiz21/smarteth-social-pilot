  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border bg-background hover:bg-accent hover:text-accent-foreground hover:shadow-card-hover",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 hover:shadow-card-hover",
        ...
        enterprise: "bg-gradient-primary text-primary-foreground hover:shadow-elegant hover:scale-105 active:scale-95 border border-primary-light/20",
        hero: "bg-gradient-hero text-primary-foreground hover:shadow-glow hover:scale-105 active:scale-95 font-semibold tracking-wide",
      },
      size: {
