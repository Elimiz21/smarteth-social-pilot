  ...
  const handleUpdateCredentials = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        // Persist secrets in localStorage so that the client can send them to edge
        // functions if the Supabase environment cannot access them. We only
        // persist values that were just updated.
